        ...
        <Grid container spacing={12} alignItems="center">
          <Grid item xs={12} md={6}>
            <div style={{ position: "relative" }}>
              <ImageContainer initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 1.2, ease: [0.16, 1, 0.3, 1] }} viewport={{ once: true }}>
                <motion.img style={{ y }} src="https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&q=80&w=1200" alt="Modern Office" />
                <div style={{ position: "absolute", inset: 0, background: `linear-gradient(to top, ${alpha("#001e29", 0.3)}, transparent)` }} />
              </ImageContainer>

              <FloatingBadge initial={{ opacity: 0, scale: 0.8 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ delay: 0.8, duration: 0.6, type: "spring" }} viewport={{ once: true }}>
            ...
            <Stack spacing={4}>
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} viewport={{ once: true }}>
                ...
                <Typography variant="h2" sx={{ fontWeight: 900, mb: 4, lineHeight: 1.1, color: "#001e29", fontSize: { xs: "2.5rem", md: "3.8rem" } }}>
                  Where Human <br />
                  Touch Meets <br />
                  <Box component="span" sx={{ color: alpha("#001e29", 0.5) }}>
                    Innovation.
                  </Box>
                </Typography>
                <Typography sx={{ color: alpha("#001e29", 0.6), fontSize: "1.15rem", lineHeight: 1.9, mb: 4 }}>
                  ...
                  consultation with surgical technical precision, we ensure your digital
                  transformation is both human-centric and future-proof.
                </Typography>
              </motion.div>
              ...
              <Stack spacing={3}>
                {features.map((text, i) => (
                  <Stack
                    ...
                    alignItems="center"
                  >
                    <FeatureMarker whileInView={{ rotate: 45 }} transition={{ delay: 0.8 + i * 0.1 }} />
              ...
              <Box component={motion.div} initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ delay: 1, duration: 0.5 }} viewport={{ once: true }} sx={{ pt: 4 }}>
                <Button
                  variant="outlined"
                  sx={{
                    color: "#001e29",
