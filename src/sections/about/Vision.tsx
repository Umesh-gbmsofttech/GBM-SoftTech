// @ts-nocheck
import { Box, Container, Grid, Typography, Button, Stack, Paper, alpha } from "@mui/material";
      ...
      <Container maxWidth="lg" sx={{ py: 10 }}>
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={7}>
            ...
            >
              <Typography variant="overline" sx={{ color: alpha("#ffffff", 0.78), fontWeight: 800, letterSpacing: 3, mb: 1.5 }}>
