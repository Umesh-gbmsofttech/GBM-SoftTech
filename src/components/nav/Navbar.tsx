...
// Matches the "heartbeat" pulse from your Hero CTA
const pulse = keyframes`
  0% { box-shadow: 0 0 0 0 rgba(2, 74, 168, 0.4); transform: scale(1); }
  70% { box-shadow: 0 0 0 12px rgba(2, 74, 168, 0); transform: scale(1.03); }
  100% { box-shadow: 0 0 0 0 rgba(2, 74, 168, 0); transform: scale(1); }
`;
              ...
              <Button
                ...
                sx={{
                  ...
                  "&:hover": {
                    ...
                    boxShadow: `0px 8px 20px ${alpha("#024aa8", 0.3)}`,
                    animation: 'none', // Stabilize for the user to click
                  },
                }}
              >
                Contact Us
